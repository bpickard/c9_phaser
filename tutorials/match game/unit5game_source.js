...
function displayRound(){
  ...
  dataArray.push(
      {term:"Verbal IQ",definition:"Indicative of poor school performance, which leads to dropping out of school, hanging out with delinquent peers"},
      {term:"Concordance",definition:"Degree to which behaviour of MZ and DZ twins is similar"},
      {term:"The Kallikaks",definition:"Goddard’s heredity study of two different family trees, fathered by the same man"},
      {term:"Monozygotic Twins",definition:"Share 100% of the 1% of DNA that explains variation in characteristics"},
      {term:"Serotonin",definition:"Neurotransmitter, related to low self-control and aggressive-impulsive behaviour"},
      {term:"Physiognomy",definition:"Facial features reveal individual’s inner characteristics"},
      {term:"Life-course Persistent Offenders",definition:"Behaviours stem from neuropsychological deficits"},
      {term:"Conditional Free Will",definition:"People exercise free will, but choices are conditional upon physiological abilities and genetic predispositions"},
      {term:"The Superego",definition:"Freudian term for the conscience; used in explanations of psychopathy"},
      {term:"Instrumental Aggression",definition:"Learned behaviour, oriented toward some other goal or reward"}
      );
