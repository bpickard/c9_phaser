...
var defnFontStyle = {font:'12px Arial',fill:'#000000',align:'right',wordWrap:true,wordWrapWidth:290};
var titleText;
var bodyText;
var goButton;
var goButtonText;
...
function displayRound(){
  ...
  dataArray.push(
      {term:"Cultural Criminology",definition:"branch of criminology that explores the links between culture, crime, and crime control in contemporary society"},
      {term:"Active Audiences",definition:"meaning of media messages is “negotiated” through interaction between those who produce the messages and audiences who consume them"},
      {term:"The Grassroots Model",definition:"moral panics begin with genuine public concern about a social “problem” (real or imagined)"},
      {term:"The Elite-Engineered Model",definition:"small, powerful groups deliberately set out to create moral panics"},
      {term:"Media Effects",definition:"children who watch a lot of violence on TV are more likely engage in violence in real life"},
      {term:"Criminalization",definition:"process through which certain (previously tolerated) behaviours become criminal offences"},
      {term:"Primary Deviance",definition:"occurs when an individual/group engages in disapproved behaviour without seeing themselves as “deviant” or “criminal”"},
      {term:"Secondary Deviance",definition:"Individuals come to view themselves as “deviant” or “criminal” because of social reaction (stigmatization and labelling)"},
      {term:"Folk Devils",definition:"scapegoats, who are portrayed as the personification of “evil”"},
      {term:"Moral Entrepreneurs",definition:"Person, group or organization that demands new rules and/or enhanced rule enforcement"}
      );
