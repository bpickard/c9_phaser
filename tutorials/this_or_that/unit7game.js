...
function setQuestions(){
    round = [];
    round.push([{text:"Nodes, paths and edges",category:"The Brantinghams"},
                  {text:"The environmental backcloth",category:"The Brantinghams"},
                  {text:"Offender awareness space",category:"The Brantinghams"},
                  {text:"The metroreef",category:"Marcus Felson"},
                  {text:"The principle of least effort",category:"Marcus Felson"}]);

                  
                  
    round.push([{text:"Cohen and Felson",category:"Routine activity theory"},
                  {text:"Absence of capable guardianship",category:"Routine activity theory"},
                  {text:"Dramatic rise in crime rates",category:"Routine activity theory"},
                  {text:"A suitable target (opportunity)",category:"Routine activity theory"},
                  {text:"The three social domains",category:"Routine activity theory"},
                  {text:"Ronald V. Clarke",category:"Situational Crime Prevention"},
                  {text:"Target hardening",category:"Situational Crime Prevention"},
                  {text:"Costs and benefits ",category:"Situational Crime Prevention"},
                  {text:"Increasing the risks",category:"Situational Crime Prevention"},
                  {text:"Reducing the rewards",category:"Situational Crime Prevention"}]);
                  
                                    

                  
    round.push([{text:"Crime generators",category:"Nodes"},
                  {text:"The three social domains",category:"Nodes"},
                  {text:"Crime attractors",category:"Nodes"},
                  {text:"Entertainment districts",category:"Nodes"},
                  {text:"Sidewalks",category:"Paths"},
                  {text:"Transit routes",category:"Paths"},
                  {text:"Roads",category:"Paths"},
                  {text:"Riverbanks",category:"Edges"},
                  {text:"A dark forest",category:"Edges"},
                  {text:"Changes in land use",category:"Edges"}]);
