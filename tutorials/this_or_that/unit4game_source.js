...
var buttonFontStyle= {font:'16px Arial',fill:'#FFFFFF',align:'center'};
...
function setQuestions(){
    round = [];
    round.push([{text:"free will",category:"Classical School"},
                  {text:"Cesare Beccaria",category:"Classical School"},
                  {text:"Hedonistic Calculus",category:"Classical School"},
                  {text:"Cesare Lombroso",category:"Positivist School"},
                  {text:"atavisms",category:"Positivist School"}]);

                  
                  
    round.push([{text:"Cornish and Clarke",category:"Rational Choice Theory"},
                  {text:"limited rationality",category:"Rational Choice Theory"},
                  {text:"cost-benefit analysis",category:"Rational Choice Theory"},
                  {text:"the purposive nature of crime",category:"Rational Choice Theory"},
                  {text:"Neo-Classicism",category:"Rational Choice Theory"},
                  {text:"Gottfredson and Hirschi",category:"General Theory of Crime"},
                  {text:"low self-control",category:"General Theory of Crime"},
                  {text:"ineffective child-rearing",category:"General Theory of Crime"},
                  {text:"explains all crime,\nall the time",category:"General Theory of Crime"},
                  {text:"incomplete socialization",category:"General Theory of Crime"}]);
                  
                                    

                  
    round.push([{text:"Ronald Akers",category:"Social Learning Theory"},
                  {text:"neutralizing definitions",category:"Social Learning Theory"},
                  {text:"differential reinforcement",category:"Social Learning Theory"},
                  {text:"discriminitive stimuli",category:"Social Learning Theory"},
                  {text:"Albert Bandura",category:"Imitation and Modeling"},
                  {text:"vicarious learning",category:"Imitation and Modeling"},
                  {text:"Bo-Bo Doll Experiment",category:"Imitation and Modeling"},
                  {text:"Edwin Sutherland",category:"Differential Association"},
                  {text:"Chicago School",category:"Differential Association"},
                  {text:"symbolic interactionism",category:"Differential Association"}]);
