...
var buttonFontStyle= {font:'14px Arial',fill:'#FFFFFF',align:'center'};
...
function setQuestions(){
    round = [];
    round.push([{text:"The forces of integration",category:"Emile Durkheim"},
                  {text:"Originator of anomie theory",category:"Emile Durkheim"},
                  {text:"The cultural goals",category:"Robert Merton"},
                  {text:"The institutional means",category:"Robert Merton"},
                  {text:"Five modes of adaptation",category:"Robert Merton"}]);

                  
                  
    round.push([{text:"Robert Agnew",category:"General Strain Theory"},
                  {text:"Stress moderators",category:"General Strain Theory"},
                  {text:"Negative stimuli",category:"General Strain Theory"},
                  {text:"Negative affect",category:"General Strain Theory"},
                  {text:"Anger and frustration",category:"General Strain Theory"},
                  {text:"Terrence Thornberry",category:"Interactional Theory"},
                  {text:"Reciprocal causal loop",category:"Interactional Theory"},
                  {text:"Combines social bonds\nand social learning",category:"Interactional Theory"},
                  {text:"Backdrop of social\ndisorganization and anomie",category:"Interactional Theory"},
                  {text:"Social bonds are dynamic",category:"Interactional Theory"}]);
                  
                                    

                  
    round.push([{text:"Transitions",category:"Sampson and Laub"},
                  {text:"Trajectories",category:"Sampson and Laub"},
                  {text:"Social capital",category:"Sampson and Laub"},
                  {text:"Turning points",category:"Sampson and Laub"},
                  {text:"Interactional theory",category:"Terrence Thornberry"},
                  {text:"Social bond theory\nas unidirectional",category:"Terrence Thornberry"},
                  {text:"Social learning theory\nas unidirectional",category:"Terrence Thornberry"},
                  {text:"General strain theory",category:"Robert Agnew"},
                  {text:"Addresses criticisms of\nanomie-strain theory",category:"Robert Agnew"},
                  {text:"Pain avoidance behaviour",category:"Robert Agnew"}]);
