...
function introduction(){
        titleText = game.add.text(game.world.centerX,((game.world.height/7)*2),'AV, IT, or ETS - The Game!',titleFontStyle);
        titleText.anchor.setTo(0.5,0.5);
        
        bodyText = game.add.text(game.world.centerX,((game.world.height/7)*3.25),'Instructions: Different computer help scenarios will appear \n on the screen. Guess which department the request belongs\n to before time runs out!',bodyFontStyle);
...
function setQuestions(){
    ...
    round.push([{text:"I can't get on to the\n wireless network!",category:"IT Services"},
                {text:"My computer is acting funny.",category:"IT Services"},
                {text:"I can't log in to\nConnect/UBC Blogs/e-mail!",category:"IT Services"},
                {text:"I need someone to help\nme record a video lecture.",category:"ETS"},
                {text:"I need help setting up\na projector in Scarfe.",category:"AV Services"},
                {text:"There is a problem with the\nSmartBoard in room XXX",category:"AV Services"},
                {text:"I need to set up a\nvideo conference in 308A.",category:"AV Services"},
                {text:"I need help\nwith Connect",category:"ETS"},
                {text:"I need help\nwith UBC blogs",category:"ETS"},
                {text:"I am designing a course\nand I want some help",category:"ETS"}]);
