...
function setQuestions(){
    ...
    round.push([{questionText:"There is a higher likelihood of crimes being detected and recorded when the police engage in what is known as “reactive policing.”",answer:"false"},
                {questionText:"The “security hypothesis” refers to the notion that the recent decrease in police-reported crime rates is attributable to the increase in the number of private security forces.",answer:"false"},
                {questionText:"According to the General Social Survey, victimization rates mostly went up during the period from 1999 through 2009.",answer:"true"},
                {questionText:"The “crime swap” describes the “deviant exchange,” where criminals may swap one criminal service for another (e.g., exchanging drugs for prostitution).",answer:"false"},
                {questionText:"Routine activities theory and lifestyle exposure theory both emerged in the late 1970s, and were both premised on the results of victimization surveys.",answer:"true"}]);
                
    round.push([{questionText:"According to the Uniform Crime Report:\n\nA) crime rates stayed the same between 1993 and 2013\n\nB) crime rates increased by 28% between 1993 and 2013\n\nC) motor vehicle thefts declined by 43% between 2003 and 2013\n\nD) in 2013, robbery rates reached their highest level in 30 years",answer:"c"},
                {questionText:"The “security hypothesis” refers to the notion that:\n\nA) the decline in motor vehicle thefts may be attributable to better door locks, central locking systems and electronic immobilizers\n\nB) the decline in motor vehicle thefts may be attributable to greater use of speed bumps and other traffic calming measures, that make joyriding less attractive\n\nC) the recent decrease in police-reported crime rates is attributable to the increase in the number of private security forces\n\nD) “A” and “B” only",answer:"d"},
                {questionText:"Routine activities theory:\n\nA) was advanced by Hindelang, Gottfredson and Garofalo in 1971\n\nB) argues that “capable guardianship” is largely irrelevant, as the presence of family members or other prospective interveners rarely prevents a criminal event\n\nC) argues that most predatory criminal events will occur in one of the three main social domains—the family, the workplace, or the leisure domain\n\nD) argues that offender routines and victim routines are substantively different, thus reducing the potential for offenders and victims to intersect in time and space",answer:"c"},
                {questionText:"In “Homicide as a Situated Transaction,” David Luckenbill\n\nA) examined 500 murders that occurred in Detroit between 1951 and 1958\n\nB) concluded that the main contributing factor in these situated transactions was psychopathology or sociopathy on the part of the offender\n\nC) concluded that the majority of these situated transactions occurred during working hours, either in the work place, or while travelling to and from work\n\nD) concluded that all of these transactions took place in permissive environs, during evenings and weekends",answer:"d"},
                {questionText:"According to the General Social Survey, the rates of criminal victimization in Canada are highest:\n\nA) in rural areas, where many people own guns for hunting, and are prepared to use them with little consideration as to the consequences\n\nB) in provinces that do not have the death penalty \n\nC) for young people between the ages of 15 and 24\n\nD) for people who are over the age of 65",answer:"c"}]);
