...
function setQuestions(){
    ...
    round.push([{questionText:"Robbery is classified as a “‘violent” crime because most robberies involve either a weapon or injury to the victim (or both).",answer:"false"},
                {questionText:"Assault level 3 is sometimes referred to as “aggravated assault.” ",answer:"true"},
                {questionText:"The difference between assault and homicide is that the victim survives an assault.",answer:"true"},
                {questionText:"Violent crime rates are lowest in the Northwest Territories and Nunavut, higher in Western Canada, and highest in Eastern Canada.",answer:"false"},
                {questionText:"60% of female sexual assault victims are not physically injured as a result of the assault.",answer:"true"}]);
                
    round.push([{questionText:"According to the General Social Survey:\n\nA) sexual assault is the most frequently reported form of violent crime\n\nB) sexual assault level 3 accounts for the majority of reported sexual offences\n\nC) approximately 40% of robberies are reported to the police\n\nD) sexual assault level 2 includes unwanted sexual touching, unwanted grabbing, or unwanted kissing",answer:"c"},
                {questionText:"Wolfgang and Ferracuti’s 1967 work on “subcultures of violence”:\n\nA) was premised in part on Edwin Sutherland’s differential association theory\n\nB) was intended primarily to explain gang warfare \n\nC) was intended primarily to explain gang warfare \n\nD) concluded that there was no empirical evidence for the existence of “subcultures of violence”",answer:"a"},
                {questionText:"Elijah Anderson’s work on the “code of the street”:\n\nA) talks about the social construction of meaning, the social construction of self-image, and “presentation of self”\n\nB) offers an explanation for the higher levels of violence in Aboriginal communities across Canada \n\nC) is a replication of James Messerschmidt’s 1993 study on “males and masculinities”\n\nD) is a replication of James Messerschmidt’s 1993 study on “males and masculinities”",answer:"a"},
                {questionText:"With respect to sexual offending, it can be said that:\n\nA) most sexual offenders fall into the “life-course-persistent” category\n\nB) 75% of sexual offences are committed by total strangers  \n\n60% of female sexual assault victims are physically injured by their attacker\n\nD) 60% of female sexual assault victims are physically injured by their attacker",answer:"d"},
                {questionText:"Examples of the Community Protection Approach include:\n\nA) rehabilitation and treatment programs for sexual offenders\n\nB) the Sex Offender Registry \n\nC) cognitive-behavioural programs\n\nD) anger management programs ",answer:"b"}]);
